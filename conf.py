...
# -*- coding: utf-8 -*-
#
# aiphilos documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'aiphilos.tex', 'aiphilos Documentation',
     'aiPhilos', 'manual'),
]
...
man_pages = [
    (master_doc, 'aiphilos', 'aiphilos Documentation',
     [author], 1)
]
